// 7.13.7.cpp : 此文件包含 "main" 函数。程序执行将在此处开始并结束。
//《C++ Primer Plus》p251
...
auto Fill_array(array<double, MAXN> &arr);
void Show_array(array<double, MAXN>::const_iterator &begin_it);
